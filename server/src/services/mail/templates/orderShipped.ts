...
const orderShippedHtml = (
    ...
    <mjml>
		...
		<mj-body background-color="#ffffff" padding-top="50px" width="800px">
			<mj-section>
				<mj-column>
					<mj-text mj-class="bold">Your Order has been Shipped!</mj-text>
					...
					<mj-text mj-class="gutterbottom">
						Thank you again for your purchase, your order has shipped!
					</mj-text>
					<mj-text mj-class="gutterbottom">
						Shipping Method
					</mj-text>
			...
			<mj-section>
				<mj-column>
					...
					<mj-text>Your order is being sent to: </mj-text>
					...
					<mj-text mj-class="gutterbottom">
						This completes you order. If you have any questions or need further assistance, <br />
...
export default orderShippedHtml
