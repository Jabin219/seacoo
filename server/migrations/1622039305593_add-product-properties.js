...
exports.up = pgm => {
	pgm.addColumns(
		'Products',
		{
			...
			propertiesZh: { type: 'text' }
		},
		{}
	)
	pgm.sql(`
		UPDATE "Products"
		SET "properties" = 'Sea Cucumber ｜ 100% Natural ｜ Supplement'
		WHERE "id" = '7f87ea9b-c652-40ad-82f4-17db00ce3542';
		UPDATE "Products"
		SET "propertiesZh" = '浓缩胶囊 ｜ 纯天然原料 ｜ 海参补充剂'
		WHERE "id" = '7f87ea9b-c652-40ad-82f4-17db00ce3542';
		UPDATE "Products"
		SET "properties" = 'WestCoast ｜ Sea Cucumber ｜Wild-Caught'
		WHERE "id" = '2959ade1-e357-44a6-9d40-4dd1d58da24e'
		OR "id" = 'f2411b6a-e1a1-47cd-b585-89703b16c559';
		UPDATE "Products"
		SET "propertiesZh" = '西海岸红刺参 ｜ 野生海参 ｜ 天然抗氧化食品'
		WHERE "id" = '2959ade1-e357-44a6-9d40-4dd1d58da24e'
		OR "id" = 'f2411b6a-e1a1-47cd-b585-89703b16c559';
		UPDATE "Products"
		SET "properties" = 'EastCoast ｜ Sea Cucumber ｜Wild-Caught'
		WHERE "id" = '303517f2-aea8-4ee4-b7eb-b22dd16ddef9'
		OR "id" = '847f7f49-c912-46a7-9472-4c57602b3959';
		UPDATE "Products"
		SET "propertiesZh" = '东海岸北极参 ｜ 野生海参 ｜ 天然抗氧化食品'
		WHERE "id" = '303517f2-aea8-4ee4-b7eb-b22dd16ddef9'
		OR "id" = '847f7f49-c912-46a7-9472-4c57602b3959';
		UPDATE "Products"
		SET "properties" = 'EastCoast ｜ Sea Cucumber ｜Wild-Caught'
